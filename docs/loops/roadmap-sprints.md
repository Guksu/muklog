...
| 3 (map-category-filter) | ✅ 통과 — qa-visual 하드페일 0 / qa-logic 이슈 0 / 177 스위트·1,658 테스트 green / tsc 0 | 백엔드·브리지 변경 0(소스 레벨 순수 필터). 중단 1회(qa-logic 세션 한도 — 한도 해제 후 재개, 막힘 아님). 디바이스 스모크 이월 2(칩 가독성·오버레이 비충돌). 사용자 커밋 대기 중 |
