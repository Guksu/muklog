...
| U56 | 먹로그 상세 | 사진을 탭해도 아무 일 없음 — 원본 크게 볼 수 없음(사용자 직접 요청 2026-09-04 ①) | 1 | 사진 탭 → 전체화면 뷰어·좌우 이동·1~3배 확대. 기존 RNGH와 Animated 사용으로 새 의존성 불필요. 기존 signed URL 재사용 | 상 | 중 | 없음(킷은 상세 뷰어 침묵) | 구현 완료(feat/photo-viewer): 217 suites/2466 tests 통과, iOS 버튼 확대·닫기·재진입 확인. 제스처·Android 실기기 검증 남음 |
